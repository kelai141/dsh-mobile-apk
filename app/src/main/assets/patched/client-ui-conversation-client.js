	...
	factory: (require) => {
		...
		* (running/removed/promptError) are self-selected via useSession. */
		...
		function InputBar({ useSession, useInput, inputActions, keyboard, addImages, removeImage, draftImages, resolveSubmitMode, toggleCommandMenu, stop, command, t, renderSlot, useNotices, useLexicon, useMenuLauncher, useProjection, sessionId, variant, disabled: inert = false, blocked, workspacePickerOpen = false, onRequestWorkspace, placeholder, accessory, overlay, leftItems, rightItems, footer }) {
			...
			(0, react.useEffect)(() => {
				if (window.__dshBridge === void 0) window.__dshBridge = {};
				window.__dshBridge.onImagePicked = async (callbackId, info) => {
					if (info === null || info === void 0) return;
					try {
						const res = await fetch(info.dataUrl);
						const blob = await res.blob();
						const file = new File([blob], info.name || "image", { type: info.mediaType || "image/jpeg" });
						intakeImages([file]);
					} catch (e) {
					}
				};
										...
										(0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
											...
											children: (0, react_jsx_runtime.jsx)("button", {
												...
												children: (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconPlusOutline16, { size: 14 })
																																																																																...
																																																																																isAndroid && (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Tooltip, {
																																									label: "添加图片",
																																									side: "top",
																																									delayMs: 500,
																																									children: (0, react_jsx_runtime.jsx)("button", {
																																										...
																																										onMouseDown: keepFocus,
																																										onClick: () => {
																																											var cb = "img-" + Date.now() + "-" + Math.random().toString(36).slice(2, 8);
																																											if (window.__dshBridge === void 0) window.__dshBridge = {};
																																											window.__dshBridge.__pendingImagePick = cb;
																																											var bridge = window.androidBridge;
																																											if (bridge !== void 0 && typeof bridge.pickImage === "function") bridge.pickImage(cb);
																																										},
																																										children: (0, react_jsx_runtime.jsx)("img", {
																																											src: "data:image/png;base64,",
																																											alt: "",
